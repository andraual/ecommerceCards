<%-- 
    Document   : exemplo
    Created on : 11/11/2019, 21:07:57
    Author     : André
--%>
...
<body>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" style='height:350px'>
          <div class="carousel-item active">
            <img class="d-block w-100" src="img/mtg.jpg" alt="First slide" style='height:350px'>
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="img/yugi.png" alt="Second slide" style='height:350px'>
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="img/pokemon.jpg" alt="Third slide" style='height:350px'>
          </div>
        </div>
	...
	<div class="row">
		<div class="col-md-12">
                    <h3 class="text-center" style="padding-top:50px; color:white;">
				Ofertas da SEMANA! Tempo L I M I T A D O !
